...
export const ManageableNavigationComponent = () => {
    ...
    const [filteredManageables, setFilteredManageables] = useState<IManageable[]>([]);
    ...
    useEffect(() => {
        setFilteredManageables(
            useManageables.get().filter(manageable =>
                manageable.title.toLowerCase().includes(filterInput.toLowerCase()))
        )
        ...
        <div className={css.navigation}>
            <div className={css.wrapper}>
                ...
                <div className={css.items}>
                    {filteredManageables.map(o => <ManageableItemComponent manageable={o}/>)}
                </div>
            </div>
        </div>
    )
