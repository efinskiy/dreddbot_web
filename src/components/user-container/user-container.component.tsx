        ...
        <div className={css.main_container}>
            <div className={css.container}>
                ...
                <span className={css.container__row}>
                    ...
                    {user?.is_trusted ? <span>Да</span> : <span>Нет</span>}
                </span>
                <span className={css.container__row}>
                    Имеет доступ к веб-интерфейсу:{' '}
                    {user?.has_web_access ? <span>Да</span> : <span>Нет</span>}
                </span>
                <span className={css.container__row}>
                    Уволен:{' '}
                    {user?.is_fired ? <span>Да</span> : <span>Нет</span>}
                </span>
            </div>
            <div className={css.container}>
                ...
                {user?.manageable_ref && user.manageable_ref.length > 0 ? (
                    <></>
                ) : (
                    <span>Пусто.</span>
                )}
